namespace _05_Queue
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            DataStructure.AdapterQueue<int> adapterQueue = new DataStructure.AdapterQueue<int>();

            for (int i = 0; i < 5; i++) adapterQueue.Enqueue(i);

            Console.WriteLine(adapterQueue.Peek());

            while (adapterQueue.Count > 0) Console.WriteLine(adapterQueue.Dequeue());     // 출력순서 : 0, 1, 2, 3, 4
        }
    }
}